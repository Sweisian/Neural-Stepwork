import os
from bpmFinder import getBPM
from onsetDetection import getOnsets, notesToMeasures, onsetsToNotes



def writeSimfile(title="",artist="",music="",offset=-0.000000,bpms=0):
    ...
    notes = onsetsToNotes(getOnsets(music), bpms)
    measures = notesToMeasures(notes, bpms,music)
...
writeSimfile(title="Nekozilla",music=music,bpms=getBPM(music))
